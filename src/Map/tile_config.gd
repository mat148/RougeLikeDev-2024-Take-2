...
var tileRules = {
	...
	'TILE_GRASS_ONE': [
		#NORTH
		['TILE_GRASS_ONE', 'TILE_SIDEWALK_SOUTH', 'TILE_SIDEWALK_CORNER_LARGE_SE', 'TILE_SIDEWALK_CORNER_LARGE_SW'],
		#EAST
		['TILE_GRASS_ONE', 'TILE_SIDEWALK_WEST', 'TILE_SIDEWALK_CORNER_LARGE_NW', 'TILE_SIDEWALK_CORNER_LARGE_SW'],
		#SOUTH
		['TILE_GRASS_ONE', 'TILE_SIDEWALK_NORTH', 'TILE_SIDEWALK_CORNER_LARGE_NW', 'TILE_SIDEWALK_CORNER_LARGE_NE'],
		#WEST
		['TILE_GRASS_ONE', 'TILE_SIDEWALK_EAST', 'TILE_SIDEWALK_CORNER_LARGE_NE', 'TILE_SIDEWALK_CORNER_LARGE_SE']
	],
